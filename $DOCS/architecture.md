...
NextGig is a fullstack MVP built for the SIH 2026 hackathon PS26044. It uses a modern Next.js 14 stack (App Router) with React, TypeScript, and Tailwind CSS. The design system leverages Shadcn UI and Framer Motion for premium, animated interfaces.
