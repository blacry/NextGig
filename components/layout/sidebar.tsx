...
function getAcademicianNavItems(slug: string): NavItem[] {
  return [
    ...
    {
      label: "My Profile",
      href: `/academician/${slug}/dashboard?tab=profile`,
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>,
    },
    {
      label: "My Skills",
      href: `/academician/${slug}/dashboard?tab=skills`,
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>,
    },
    {
      label: "Learning Hub",
      href: `/academician/${slug}/dashboard?tab=learning`,
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>,
    },
    {
      label: "Opportunities",
      href: `/academician/${slug}/dashboard?tab=opportunities`,
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>,
    },
    {
      label: "Applications",
      href: `/academician/${slug}/dashboard?tab=applications`,
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>,
    },
    {
      label: "Mentoring",
      href: `/academician/${slug}/dashboard?tab=mentoring`,
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
    },
    {
      label: "Reports",
      href: `/academician/${slug}/dashboard?tab=reports`,
    ...
    {
      label: "Settings",
      href: `/academician/${slug}/dashboard?tab=settings`,
...
interface SidebarProps {
  variant: "student" | "recruiter" | "academician";
}
...
export function Sidebar({ variant }: SidebarProps) {
  ...
  const homeHref =
    variant === "student"
      ? `/student/${userSlug}/dashboard`
      : variant === "academician"
      ? `/academician/${userSlug}/dashboard`
      : `/recruiter/${userSlug}/dashboard`;

  const NavContent = () => (
    <div className="flex flex-col h-full">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-border">
        <Link href={homeHref} className="flex items-center gap-2.5 min-h-0 min-w-0">
          <div className="w-8 h-8 rounded-full bg-[#123B6D] flex items-center justify-center border border-[#D9E1EA]">
            <span className="text-amber-300 font-serif font-black text-sm">V</span>
          </div>
          <span className="font-bold text-base tracking-tight text-[#123B6D]">VRIDHI</span>
        </Link>
      </div>
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-background/80 backdrop-blur-sm border-b border-border px-4 py-3 flex items-center justify-between">
        <Link href={homeHref} className="flex items-center gap-2 min-h-0 min-w-0">
